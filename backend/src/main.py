...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    try:
        ...
        if kafka_success:
            logger.info("[SUCCESS]  Confluent Kafka integration ready")
        else:
            logger.warning("[WARNING]  Confluent Kafka initialization failed")
        
    except Exception as e:
        logger.warning(f"[WARNING]  Confluent Kafka integration failed, continuing without Kafka: {e}")
