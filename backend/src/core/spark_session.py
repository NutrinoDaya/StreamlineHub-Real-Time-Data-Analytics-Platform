...
def init_spark_session(job_name: Optional[str] = None, master: Optional[str] = None, additional_config: Optional[Dict[str, str]] = None) -> SparkSession:
    """
    ...
    Args:
        ...
        master: Optional master URL (overrides config)
        additional_config: Optional dictionary of additional Spark configurations
    ...
    master_url = master or spark_config.get("master_url", "local[*]")
...
def get_spark_session(job_name: Optional[str] = None, master: Optional[str] = None, additional_config: Optional[Dict[str, str]] = None) -> SparkSession:
    """
    ...
    if _spark_session is None:
        _spark_session = init_spark_session(job_name, master, additional_config)
    return _spark_session
