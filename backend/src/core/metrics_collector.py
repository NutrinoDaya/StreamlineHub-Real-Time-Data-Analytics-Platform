...
class MetricsCollector:
    ...
    async def initialize(self) -> bool:
        ...
        try:
            logger.info("[ANALYZING]  Initializing Metrics Collector...")
            ...
            logger.error(f"[ERROR]  Failed to initialize Metrics Collector: {e}")
            return False
    ...
    async def start_collection(self):
        ...
        if not self.monitoring_active:
            ...
            logger.info("[SEARCHING]  Started metrics collection")
    ...
    async def shutdown(self):
        ...
        logger.info("[ANALYZING]  Metrics Collector shutdown complete")
